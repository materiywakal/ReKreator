...
namespace ReKreator.DAL.Migrations
{
    ...
    [Migration("20190328112504_FillAndSetRequiredPropetryToNormalizedEmailAndNormalizedUserNameOfUserEntityMigration")]
    partial class FillAndSetRequiredPropetryToNormalizedEmailAndNormalizedUserNameOfUserEntityMigration
    {
            ...
            modelBuilder.Entity("ReKreator.Domain.User_UserRole", b =>
                {
                    ...
                    b.HasOne("ReKreator.Domain.UserRole", "UserRole")
                        .WithMany("Users_UserRoles")
